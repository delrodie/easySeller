...
class FactureRepository extends \Doctrine\ORM\EntityRepository
{
   ...
   */
   ...
   /**
    * Le montant du net a payer de la facture
    *
    * @author: Delrodie AMOIKON
    * @date: 02/05/2017 19:38
    */
    public function getNetAPayer($id)
    {
      $em = $this->getEntityManager();
      ...
      $montant = $qb->getSingleScalarResult();

       return $montant;
    }

    /**
     * Le nombre de facture par client
	 *
	 * @author: Delrodie AMOIKON
	 * @date: 04/05/2017
     */
	public function findNombreFactureDuClient($clientID)
	{
		$em = $this->getEntityManager();
    ...
    public function nombre_en_lettre($id)
    {
